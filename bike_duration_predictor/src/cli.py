...
from src.utils import parse_s3_path, read_from_local, read_from_s3, write_to_local, write_to_s3
...
@click.option(
    "--input-path",
    required=True,
    help="The path to the input CSV file. Can be local or S3 path.",
)
@click.option(
    "--output-path",
    required=True,
    help="The path to the output CSV file. Can be local or S3 path.",
)
...
@click.option(
    "--input-path",
    required=True,
    help="The path to the processed CSV file. Can be local or S3 path.",
)
@click.option(
    "--output-path",
    required=True,
