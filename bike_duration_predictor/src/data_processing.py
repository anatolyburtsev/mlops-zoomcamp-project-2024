...
from src.lib import convert_to_int, map_membership_type, one_hot_encode, standardize_column_names


def process_data(df: pd.DataFrame) -> pd.DataFrame:
    """Process the input DataFrame by converting specified columns to integers, parsing datetime columns, performing
    one-hot encoding, and cleaning up the data.
    ...
    df = one_hot_encode(
        ...
        [
            ...
            "membership_cat_Pay Per Ride",
            "membership_cat_Community Pass",
            "membership_cat_Monthly Pass",
            "membership_cat_Annual Pass",
